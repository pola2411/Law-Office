...
if(isset($_POST['submit'])){
   ...
   $i="INSERT INTO `users` values(NULL,'$name',$age,'$address','$phone','$email','$password')";
   $qi=mysqli_query($con,$i);
   echo "<script>
   window.location.replace('/layer_company/user_login.php')
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already have an account? <a href="/layer_company/user_login.php">Log in</a></p>
                    </div>
                  </form>
