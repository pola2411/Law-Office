...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <div class="d-flex align-items-center justify-content-between">
    <a href="/layer_company/" class="logo d-flex align-items-center">
      <img src="/layer_company/assets/img/logo.png" alt="">
      <span class="d-none d-lg-block">layer company</span>
    </a>
      ...
      <li class="nav-item dropdown pe-3">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
          ...
          <li>
            ...
            <a class="dropdown-item d-flex align-items-center" href="/layer_company/admin/my_profile.php">
