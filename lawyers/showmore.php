...
$s="SELECT * FROM `lawyers` WHERE id = $_GET[more] ";
...
<main id="main" class="main">
   ...
   <div class="container">
    ...
    <hr>
    <h3 ><?php echo "salary:  $row[salary]" ?></h3>
    <hr>
    <h3 ><?php echo "yearsEX:  $row[yearsEX]" ?></h3>
    <hr>
  ...
  <a href="/layer_company/lawyers/list.php" class="btn btn-info">back</a>
    <a  href="/layer_company/lawyers/showmore.php?delete=<?php echo "$row[id]" ?> " class="btn btn-danger">Delete </a>
    <a  href="/layer_company/lawyers/update.php?update=<?php echo "$row[id]" ?> " class="btn btn-warning">update </a>
</div>
